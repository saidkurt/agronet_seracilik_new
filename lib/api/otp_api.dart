...
class SistemOtpApi {
  ...
  Future<OtpGonderResponse> otpGonder(String telefon) async {
    final Uri uri = Uri.parse('${App.insideurl}/Sistem/SifreUnuttum/OtpGonder');
  ...
  Future<OtpDogrulaResponse> otpDogrula({
    ...
    final Uri uri = Uri.parse('${App.insideurl}/Sistem/SifreUnuttum/OtpDogrula');
  ...
  Future<YeniSifreResponse> yeniSifreKaydet({
    ...
    final Uri uri = Uri.parse('${App.insideurl}/Sistem/SifreUnuttum/YeniSifre');
